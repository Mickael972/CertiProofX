...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          {t('home.title')} {t('home.subtitle')} - CertiProof X
        </title>
        <meta name="description" content={t('home.description')} />
        <meta
          name="keywords"
          content="blockchain, NFT, IPFS, certification, proof, verification, Web3, Ethereum, Polygon, decentralized"
        />
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-sm md:text-base text-gray-400">
                  {stat.label === 'Certificates Créés'
                    ? 'Certificats Créés'
                    : stat.label === 'Documents Vérifiés'
                      ? 'Documents Vérifiés'
                      : stat.label === 'Réseaux Supportés'
                        ? 'Réseaux Supportés'
                        : stat.label === 'Formats de Fichiers'
                          ? 'Formats de Fichiers'
                          : stat.label}
                </div>
              </div>
      ...
      {/* Features Section */}
      <section
        className="py-20 bg-dark-950 relative"
        style={{
          border: 'none',
          boxShadow: 'none',
          margin: 0,
            ...
            {[
              {
                ...
                description: t(
                  'home.features.cryptographicSecurity2.description'
                ),
              },
              {
                icon: '🌐',
                ...
                description: t(
                  'home.features.decentralizedStorage2.description'
                ),
              },
              {
                icon: '💎',
              ...
              },
              {
                ...
                description: t(
                  'home.features.openSourceRevolution.description'
                ),
              },
            ].map((feature, index) => (
              <div
      ...
      <section
        className="py-20 bg-dark-900/30 backdrop-blur-sm"
        style={{
          border: 'none',
          boxShadow: 'none',
          margin: 0,
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center text-white mx-auto mb-6 shadow-lg shadow-primary-500/25 group-hover:scale-110 transition-transform">
                {/* Icône nuage pour télécharger */}
                <svg
                  className="w-10 h-10"
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-success-500 to-success-600 rounded-full flex items-center justify-center text-white mx-auto mb-6 shadow-lg shadow-success-500/25 group-hover:scale-110 transition-transform">
                {/* Icône cadenas pour certifier */}
                <svg
                  className="w-10 h-10"
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white mx-auto mb-6 shadow-lg shadow-purple-500/25 group-hover:scale-110 transition-transform">
                {/* Icône loupe pour vérifier */}
                <svg
                  className="w-10 h-10"
                  fill="none"
                  stroke="currentColor"
      ...
      {/* CTA Section */}
      <section
        className="relative bg-gradient-to-br from-dark-950 via-dark-900 to-primary-900 text-white overflow-hidden py-20"
